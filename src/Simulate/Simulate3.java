...
public class Simulate3 {
	...
	public int QueueTotalPerson[]=new int[3];	//각 큐에 있는 손님의 수
	...
	synchronized public void Start() 
	{
		...
		if(isCall != 1 && (callDo!=true && callDo2!=true && callDo3!=true))
		{
			...
			if((waitPerson!=null) && (person==4)) 
			{
				...
				//	System.out.println("세번째 창구에서 "+(waitPerson[2].peek().personNum)+"번째 손님이 나가셨습니다.");
					waitPerson[2].dequeue();
				//	System.out.println("---첫번째 조건문 : 세번째 창구에서 "+(++dalbok)+"번째 손님이 나가셨습니다.---");
				}
				// 마감시간이 아니라면 -> 손님입장 //
				else
				{
					...
					//	System.out.println("세번째 큐에 "+totalPerson+"번째 손님 입장"+" 고객의 서비스 시간은 "+client.serviceTime+"입니다.");
						personNum++;
						QueueTotalPerson[2]++;
					}
				}
			...
			else if(serviceDo==true || serviceDo2==true || serviceDo3==true) 
			{
				...
				if(serviceDo3==true)
				{
					...
					//	System.out.println("세번째 창구에서 " + (waitPerson[2].peek().personNum)+"번째 손님이 나가셨습니다.");
						waitPerson[2].dequeue();
					//	System.out.println("---두번째 조건문 : 세번째 창구에서 "+(++dalbok)+"번째 손님이 나가셨습니다.---");
					}
					else
					{
						state3=2;
					//	System.out.println("세번째 창구는 서비스 중입니다.");
					}
				}
				...
				else if(serviceDo==false || serviceDo2==false || serviceDo3==false)
				{
					...
					//	System.out.println("세번째 창구에서 "+(waitPerson[2].peek().personNum)+"번째 손님의 서비스를 시작합니다.");
						serviceDo3=true;
					}
				}
		...
		else
		{
			...
			//	System.out.println("세번째 창구에서 "+(waitPerson[2].peek().personNum)+"번째 손님이 나가셨습니다.");
				waitPerson[2].dequeue();
			//	System.out.println("---세번째 조건문 : 세번째 창구에서 "+(++dalbok)+"번째 손님이 나가셨습니다.---");
			}
			...
			if(isCall==1)
			{
				...
				//	System.out.println("전화가 왔습니다. 세번째 창구에서 전화서비스를 실시합니다.");
				//	System.out.println("서비스시간은 "+callService3.serviceTime+"입니다.");
			...
			{
				state3=6.3;
			//	System.out.println("세번째 창구 전화서비스 완료");
	...
	/*	System.out.println("*****현재시간은 "+time+"*****");
		...
		System.out.println("세번째 창구에서의 서비스 시간 : "+timeS3);
		System.out.println("첫번째 창구에서의 전화서비스 시간 : "+timeC);
		System.out.println("두번째 창구에서의 전화서비스 시간 : "+timeC2);
		System.out.println("세번째 창구에서의 전화 서비스 시간 : "+timeC3); */
	}
